...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Visualizando _MENU_ Registros",sZeroRecords:"No se encontraron Registros",sEmptyTable:"No data available in table",
sLoadingRecords:"Loading...",sInfo:"Visualizando _START_ a _END_ de _TOTAL_ Registros",sInfoEmpty:"Mostrando 0 a 0 de 0 Registros",sInfoFiltered:"(Fitrado de _MAX_ total Registros)",sInfoPostFix:"",sInfoThousands:",",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
